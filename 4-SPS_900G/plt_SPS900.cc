...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    // Define histogram
    TH1D *hist_exp = new TH1D("hist_exp", "Charged Hadron Multiplicity distributions [ 900 GeV / 6839 events ]", 54, 0, 130);
    // Beautify
    ...
    // Define histogram
	TH1D *hist_pen_1 = new TH1D("hist_pen_1", "Charged Hadron Multiplicity distributions [ 900 GeV / 6839 events ]", 54, 0, 130);
	// Beautify
	...
	// Define histogram
	TH1D *hist_pen_2 = new TH1D("hist_pen_2", "Charged Hadron Multiplicity distributions [ 900 GeV / 6839 events ]", 54, 0, 130);
	// Beautify
	...
	// Define histogram
	TH1D *hist_pen_3 = new TH1D("hist_pen_3", "Charged Hadron Multiplicity distributions [ 900 GeV / 6839 events ]", 54, 0, 130);
	// Beautify
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	ifstream infile_exp("ppb900_exp.txt");
	// Read through txt
	while (getline(infile_exp, line)) {
		...
		PrbTotal += Prb;
		// Populate histogram
		hist_exp->SetBinContent(Nch, Prb);
		// Populate error bar
		hist_exp->SetBinError(0, 0);
	}
	// Scale Probs
...
//////////////////////////////////////////////////////
	...
	PrbTotal=0;
	// Import Pythia data
	ifstream infile_pen_1("softnd_ppb900_pen.txt");
	// Read through txt
	while (getline(infile_pen_1, line)) {	
		...
		PrbTotal += Prb;
		// Populate histogram
		hist_pen_1->SetBinContent(Nch, Prb);
		// Populate error bar
		// hist_pen_hrd->SetBinError(0, 0);
	}
	// Scale Probs
	// hist_pen_1->Scale(1.0/PrbTotal);
	cout << "Cumulative Probability (Hrd) : " << PrbTotal << endl;
	// Close file
	infile_pen_1.close();
...
//////////////////////////////////////////////////////
	...
	PrbTotal=0;
	// Import Pythia data
	ifstream infile_pen_2("soft_ppb900_pen.txt");
	...
	while (getline(infile_pen_2, line)) {	
		...
		PrbTotal += Prb;
		// Populate histogram
		hist_pen_2->SetBinContent(Nch, Prb);
		// Populate error bar
		hist_pen_2->SetBinError(0, 0);
	}
	// Scale Probs
	// hist_pen_2->Scale(1.0/PrbTotal);
	cout << "Cumulative Probability (Sft) : " << PrbTotal << endl;
	// Close file
	infile_pen_2.close();
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// Create canvas
	TCanvas* c1 = new TCanvas("c1", "Nch distributions at 900 GeV for 6839 events", 800, 600);
	// Beautify
	c1->SetLogy();
	c1->SetTickx();
	c1->SetTicky();
	...
	legend->AddEntry(hist_exp, "Experimental data UA5 SppS", "p");
	legend->AddEntry(hist_pen_1, "Pythia 8.312 (S.nd)", "p");
	legend->AddEntry(hist_pen_2, "Pythia 8.312 (S.al)", "p");
