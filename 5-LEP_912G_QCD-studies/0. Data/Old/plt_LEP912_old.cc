...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// TF1 *fist_pen = new TF1("fist_pen", "([0]*(TMath::Gamma(x+[1])*TMath::Power(([2]/[1]),x))/(TMath::Gamma(x+1)*TMath::Gamma([1])*TMath::Power((1+([2]/[1])),x+[1])))", 2, 56);
	// // Beautify
	fist_pen->SetLineWidth(3);
	fist_pen->SetLineColor(kBlue);
	fist_pen->SetLineStyle(2);
	// Rename fit params
	fist_pen->SetParNames("Normalise","Shape","Trials");
	// Input fit params
	fist_pen->SetParameter(0,1.6);			// Normalisation parameter
	fist_pen->SetParameter(1,16.4);			// k - shape parameter
	...
	TF1 *fist_exp = new TF1("fist_exp", "([0]*(TMath::Gamma(x+[1])*TMath::Power(([2]/[1]),x))/(TMath::Gamma(x+1)*TMath::Gamma([1])*TMath::Power((1+([2]/[1])),x+[1])))", 2, 56);
	// // Beautify
	fist_exp->SetLineWidth(3);
	fist_exp->SetLineColor(kRed);
	fist_exp->SetLineStyle(2);
	// Rename fit params
	fist_exp->SetParNames("Normalise","Shape","Trials");
	// Input fit params
	fist_exp->SetParameter(0,1.2);			// Normalisation parameter
	fist_exp->SetParameter(1,14);			// k - shape parameter
	fist_exp->SetParameter(2,14);			// p - probability parameter
