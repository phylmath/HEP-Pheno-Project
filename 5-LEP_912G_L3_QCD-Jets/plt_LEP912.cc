...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// // Input fit params
	// fist_nChPyth->SetParameter(0,2.076);				// c - normalisation
	// fist_nChPyth->SetParameter(1,21);					// k - shape
	// fist_nChPyth->SetParameter(2,19.9);				// n - probability
	// // Perform fitting
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// // Draw histogram
	// hist_nChJets->Draw("c_ncj");

	// // Confirm normalisation
	// cout << "Integration (Pen) : " << hist_nChJets->Integral() << endl;
